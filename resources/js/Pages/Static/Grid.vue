...
<template>
  <section class="flex flex-col items-center bg-white">
    <h1 class="mt-10 text-4xl font-bold text-gray-800">
      New Listings
    </h1>
    <div
    ...
    >
      ...
      >
        <div class="">
          <img
            src="/images/Wu1mkNweNVtMyH39d-w_d.png"
            alt=""
            class=""
          >
        </div>
          ...
          <ul class="m-0 flex list-none items-center justify-between px-0 pt-6 pb-0">
            ...
            <li class="text-left">
              ...
              <ul class="m-0 flex items-center p-0 font-medium">
                ...
                <li class="ml-2 inline text-base">
                  5.0(30)
                </li>
              </ul>
            </li>
      ...
      >
        <div class="">
          <img
            src="/images/FBGUdtxU06E_G9iXSKYGo.png"
            alt=""
            class=""
          >
        </div>
      ...
      >
        <div class="">
          <img
            src="/images/WIfLo8JqsKmKmQOOdRhbt.png"
            alt=""
            class=""
          >
        </div>
      ...
      >
        <div class="">
          <img
            src="/images/BVthksHI2Avvq3KHofBLS.png"
            alt=""
            class=""
          >
        </div>
