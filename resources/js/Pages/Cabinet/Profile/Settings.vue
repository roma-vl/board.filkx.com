          ...
          <div class="mx-auto max-w-7xl">
              <div class="bg-white p-4 sm:rounded-lg sm:p-8 dark:bg-gray-700 mb-4">
                  ...
                  >
                      <button
                          type="button"
                          class="flex w-full items-center justify-between p-4 sm:p-6 text-left focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-lg hover:bg-gray-50
                           dark:hover:bg-gray-800/50 dark:bg-gray-800 transition-colors bg-gray-200"
