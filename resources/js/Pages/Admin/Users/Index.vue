            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden rounded-lg border border-gray-200 shadow bg-white p-2 mb-2">
                    <div class="relative pr-2">
                        <button
                            class="rounded-lg bg-blue-600 px-4 py-2 flex items-center border border-gray-300 hover:bg-blue-500">
                ...
                <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md bg-white p-2">
                    <div class="mb-4 flex justify-between items-center">
                        ...
                        <div class="relative">
                            <button @click="toggleDropdown"
                                ...
                                <svg class="w-5 h-5 ml-1" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                     fill="none"
                            ...
                            <div v-if="isDropdownOpen"
                                ...
                                <label v-for="heading in headings" :key="heading.key"
                                       class="flex items-center px-4 py-2 hover:bg-gray-100">
                                    <input type="checkbox" class=" mr-3 text-gray-800 rounded-sm"
                    ...
                    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 border-b mb-2">
                        ...
                        <tr v-for="user in filteredUsers" :key="user.id" class="hover:bg-gray-50">
                            ...
                            <td v-if="filteredHeadings.some(h => h.key === 'name')"
                                ...
                                <div class="relative h-10 w-10">
                                    ...
                                    <div v-else>
                                        <svg
                                            ...
                                            <ellipse transform="matrix(0.3543 0.9351 -0.9351 0.3543 171.4079 -26.089)"
                                                     style="fill:#F3DBC4;"
                                                     cx="104.596" cy="111.077" rx="17.187" ry="10.048"/>
                                            <ellipse transform="matrix(0.3543 -0.9351 0.9351 0.3543 43.9645 285.8114)"
                                                     style="fill:#EDCEAE;"
                                                     cx="228.947" cy="111.07" rx="17.187" ry="10.048"/>
                                        </svg>
                                    </div>
                            ...
                            <td v-if="filteredHeadings.some(h => h.key === 'status')" class="px-6 py-4">
                                ...
                                <div v-else>
                                        <span
                                            ...
                                            <span
                                                class="h-1.5 w-1.5 rounded-full bg-yellow-600"></span> Inactive </span>
                                </div>
                            </td>
                    ...
                    <div class="mb-4 flex justify-between items-center">
                        <div class="flex-1 pr-2">
                            <p class="w-full p-2 text-gray-600 font-medium "> Всього: {{ pagination.total }}</p>
                        </div>
